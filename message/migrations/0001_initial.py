    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('msg_out_id', models.CharField(max_length=16, unique=True, verbose_name='msg_out_id')),
                ('msg_out_name', models.CharField(max_length=24, unique=True, verbose_name='msg_out_name')),
            ],
            options={
                'verbose_name_plural': 'messages_out',
                'db_table': 'boss_message_out',
                'ordering': ['-msg_out_id'],
                'verbose_name': 'message_out',
            },
        ),
    ]
